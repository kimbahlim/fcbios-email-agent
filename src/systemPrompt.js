...
- Stomacher/blender bags, homogenizer bags, sample processing bags, frosted autoclavable bags (clear/frosted PP bags for lab homogenizers) → SORFA (S21) FIRST. These are used in food microbiology testing with stomacher/blender machines. SORFA SKUs: S21-SOR2021 (400mL plain), S21-SOR2041 (3500mL plain), S21-SOR2061 (400mL filter). Also available from LP (L03-174538 etc.) and IUL (G22). Do NOT confuse with NASCO Whirl-Pak — Whirl-Pak are sampling bags with wire tab closures, stomacher bags are plain open-top bags for homogenizers.
